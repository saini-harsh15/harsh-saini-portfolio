                  ...
                  <div className="space-y-2">
                    {resumeOptions.map((option) => (
                      <a
                        ...
                        className="group flex items-start gap-3 rounded-xl border border-white/10 bg-white/40 dark:bg-white/5 hover:bg-emerald-500/10 hover:border-emerald-400/30 focus-visible:bg-emerald-500/10 focus-visible:border-emerald-400/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400/40 px-3 py-3 transition-all duration-200 cursor-pointer"
                      >
                        ...
                        <span className="flex-1 min-w-0">
                          <span className="flex items-center gap-2 flex-wrap">
                            ...
                            {option.recommended && (
                              <span className="text-[10px] font-medium px-1.5 py-0.5 rounded-full bg-amber-500/15 text-amber-700 dark:text-amber-300 border border-amber-400/20">
                                Recommended
                              </span>
                            )}
                          </span>
